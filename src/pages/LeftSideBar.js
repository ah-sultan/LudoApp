                ...
                <div className="container">
                    <div className="flex py-100px gap-x-6">
                        ...
                        <div className="w-9/12">
                            ...
                            {/* Grid View */}
                            <div className="grid-cols-3 gap-x-6 gap-y-30px  grid invisible opacity-0 h-0 trns-1 overflow-hidden" style={showGridTab}>
                            ...
                            {/* List View */}
                            <div className="gap-y-50px  grid invisible opacity-0 h-0 trns-1 overflow-hidden" style={showlistTab}>
