                    ...
                    <div className="container">
                        <div className="w-8/12 mx-auto">
                            ...
                            <div className="flex items-center justify-between">
                                <button type="button" className="w-[98px] h-[75px] bg-tGreay-100 center-child text-3xl hover:gradient-primary hover:t-shadow-2 hover:text-white"><FaAngleLeft /></button>
                                <button type="button" className="w-[98px] h-[75px] bg-tGreay-100 center-child text-3xl hover:gradient-primary hover:t-shadow-2 hover:text-white"><FaAngleRight /></button>
                            </div>
                            {/* Blog Comments */}
