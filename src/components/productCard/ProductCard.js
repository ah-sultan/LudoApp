        ...
        <>
            <div className="group w-full">
                ...
                <div className="content pt-30px">
                    ...
                    <h6 className="my-2.5">
                        <Link href={`/shop/[id]`} as={`/shop/${props.id}`} className="text-base leading-1.2 font-medium !capitalize text-dark-950 hover:!text-primary-900 group-hover:text-[#474747]">{props.title}</Link>
                    </h6>
                    <div>
