            ...
            <div className="group w-full">
                ...
                <div className="content pt-30px">
                    <div>
                        ...
                        <BsStarFill className="inline-block text-sm mr-px text-tGreay-50" /> */}
                        {
                            Array(5).fill().map((_, id) => < BsStarFill key={id} className="inline-block text-sm mr-px text-accent-900" />)
                        }
                        {
                            Array(0).fill().map((_, id) => <BsStarFill key={id} className="inline-block text-sm mr-px text-tGreay-50" />)
                        }
