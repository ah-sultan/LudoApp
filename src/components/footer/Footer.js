import {FaTwitter, FaTumblr, FaFacebookF, FaInstagram} from 'react-icons/fa'
...
function Footer() {
  return (
    <>
        <footer className="border-[30px] border-t-0 border-white bg-[#333] ">
            <div className="container">
                <div className="flex pt-20 pb-[75px]">
            ...
            <div className="text-center pt-25px pb-5 bg-tGreay-700">
                     <p className="text-sm leading-[26px] text-white font-normal">© 2021 Jesco Made With By HasThemes.</p>
            </div>
        </footer>
    </>
  )
