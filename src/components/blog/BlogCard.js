        ...
        <div className="w-full">
            <div>
                <a href="#" className="block overflow-hidden">
                    <Image src={props.img} alt="img-1" className="hover:scale-110 hover:rotate-3 trns-1"/>
                </a>
            </div>
            <div className="pt-30px pl-30px pr-5 pb-10 bg-primary-200 ">
                ...
                <h5 className="mb-15px mt-21px">
                    <a href="#" className="text-22px text-dark-650 leading-[34px] font-bold hover:text-primary-900">{props.title}</a>
                </h5>
